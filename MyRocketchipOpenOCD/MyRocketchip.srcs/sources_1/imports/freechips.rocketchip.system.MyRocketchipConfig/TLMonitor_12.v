...
`endif // RANDOMIZE_REG_INIT
  ...
  always @(posedge clock) begin
    ...
    `ifdef STOP_COND
      if (`STOP_COND) begin
    `endif
        if (io_in_d_valid & _T_605 & _T_2) begin
          $fatal; // @[Monitor.scala 49:11]
        end
    `ifdef STOP_COND
      end
    ...
    `ifdef STOP_COND
      if (`STOP_COND) begin
    `endif
        if (_T_617 & (io_in_d_valid & _T_653 & _T_2)) begin
          $fatal; // @[Monitor.scala 49:11]
        end
    `ifdef STOP_COND
      end
    ...
    `ifdef PRINTF_COND
      if (`PRINTF_COND) begin
    `endif
        if (io_in_d_valid & _T_653 & _T_2 & _T_617) begin
          $fwrite(32'h80000002,
    ...
    `ifdef STOP_COND
      if (`STOP_COND) begin
    `endif
        if (_T_617 & (io_in_d_valid & _T_699 & _T_2)) begin
          $fatal; // @[Monitor.scala 49:11]
        end
    `ifdef STOP_COND
      end
    ...
    `ifdef PRINTF_COND
      if (`PRINTF_COND) begin
    `endif
        if (io_in_d_valid & _T_699 & _T_2 & _T_617) begin
          $fwrite(32'h80000002,
...
`ifdef RANDOMIZE_REG_INIT
  ...
  _RAND_17 = {5{`RANDOM}};
  inflight_sizes_1 = _RAND_17[151:0];
  _RAND_18 = {1{`RANDOM}};
