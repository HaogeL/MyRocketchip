...
`endif // RANDOMIZE_REG_INIT
  ...
  wire [13:0] _T_87 = io_in_a_bits_address ^ 14'h3000; // @[Parameters.scala 137:31]
  wire [14:0] _T_88 = {1'b0,$signed(_T_87)}; // @[Parameters.scala 137:49]
  wire [14:0] _T_90 = $signed(_T_88) & -15'sh1000; // @[Parameters.scala 137:52]
  wire  _T_91 = $signed(_T_90) == 15'sh0; // @[Parameters.scala 137:67]
  ...
  wire  _T_361 = _T_84 & _T_132; // @[Monitor.scala 115:71]
  ...
  wire  _T_461 = io_in_a_bits_size <= 4'h3; // @[Parameters.scala 92:42]
  wire  _T_469 = _T_461 & _T_91; // @[Parameters.scala 670:56]
  wire  _T_471 = _T_84 & _T_469; // @[Monitor.scala 131:74]
  wire  _T_481 = io_in_a_bits_param <= 3'h4; // @[Bundles.scala 138:33]
  wire  _T_489 = io_in_a_bits_opcode == 3'h3; // @[Monitor.scala 138:25]
  wire  _T_535 = io_in_a_bits_param <= 3'h3; // @[Bundles.scala 145:30]
  wire  _T_543 = io_in_a_bits_opcode == 3'h5; // @[Monitor.scala 146:25]
  wire  _T_589 = io_in_a_bits_param <= 3'h1; // @[Bundles.scala 158:28]
  wire  _T_601 = io_in_d_bits_opcode <= 3'h6; // @[Bundles.scala 42:24]
  ...
  wire  _T_605 = io_in_d_bits_opcode == 3'h6; // @[Monitor.scala 310:25]
  wire  _T_609 = io_in_d_bits_size >= 4'h3; // @[Monitor.scala 312:27]
  wire  _T_613 = io_in_d_bits_param == 2'h0; // @[Monitor.scala 313:28]
  wire  _T_617 = ~io_in_d_bits_corrupt; // @[Monitor.scala 314:15]
  wire  _T_621 = ~io_in_d_bits_denied; // @[Monitor.scala 315:15]
  wire  _T_625 = io_in_d_bits_opcode == 3'h4; // @[Monitor.scala 318:25]
  wire  _T_636 = io_in_d_bits_param <= 2'h2; // @[Bundles.scala 102:26]
  wire  _T_640 = io_in_d_bits_param != 2'h2; // @[Monitor.scala 323:28]
  wire  _T_653 = io_in_d_bits_opcode == 3'h5; // @[Monitor.scala 328:25]
  wire  _T_673 = _T_621 | io_in_d_bits_corrupt; // @[Monitor.scala 334:30]
  wire  _T_682 = io_in_d_bits_opcode == 3'h0; // @[Monitor.scala 338:25]
  wire  _T_699 = io_in_d_bits_opcode == 3'h1; // @[Monitor.scala 346:25]
  wire  _T_717 = io_in_d_bits_opcode == 3'h2; // @[Monitor.scala 354:25]
  ...
  wire  _T_747 = io_in_a_valid & ~a_first; // @[Monitor.scala 389:19]
  wire  _T_748 = io_in_a_bits_opcode == opcode; // @[Monitor.scala 390:32]
  wire  _T_752 = io_in_a_bits_param == param; // @[Monitor.scala 391:32]
  wire  _T_756 = io_in_a_bits_size == size; // @[Monitor.scala 392:32]
  wire  _T_760 = io_in_a_bits_source == source; // @[Monitor.scala 393:32]
  wire  _T_764 = io_in_a_bits_address == address; // @[Monitor.scala 394:32]
  ...
  wire  _T_771 = io_in_d_valid & ~d_first; // @[Monitor.scala 541:19]
  wire  _T_772 = io_in_d_bits_opcode == opcode_1; // @[Monitor.scala 542:29]
  wire  _T_776 = io_in_d_bits_param == param_1; // @[Monitor.scala 543:29]
  wire  _T_780 = io_in_d_bits_size == size_1; // @[Monitor.scala 544:29]
  wire  _T_784 = io_in_d_bits_source == source_1; // @[Monitor.scala 545:29]
  wire  _T_788 = io_in_d_bits_sink == sink; // @[Monitor.scala 546:29]
  wire  _T_792 = io_in_d_bits_denied == denied; // @[Monitor.scala 547:29]
  ...
  wire  _T_798 = io_in_a_valid & a_first_1; // @[Monitor.scala 648:26]
  ...
  wire  _T_801 = _a_first_T & a_first_1; // @[Monitor.scala 652:27]
  ...
  wire [18:0] _T_803 = inflight >> io_in_a_bits_source; // @[Monitor.scala 658:26]
  wire  _T_805 = ~_T_803[0]; // @[Monitor.scala 658:17]
  ...
  wire  _T_809 = io_in_d_valid & d_first_1; // @[Monitor.scala 671:26]
  wire  _T_811 = ~_T_605; // @[Monitor.scala 671:74]
  wire  _T_812 = io_in_d_valid & d_first_1 & ~_T_605; // @[Monitor.scala 671:71]
  wire [31:0] _d_clr_wo_ready_T = 32'h1 << io_in_d_bits_source; // @[OneHot.scala 57:35]
  wire [31:0] _GEN_21 = io_in_d_valid & d_first_1 & ~_T_605 ? _d_clr_wo_ready_T : 32'h0; // @[Monitor.scala 671:90 672:22]
  ...
  wire [31:0] _GEN_22 = _d_first_T & d_first_1 & _T_811 ? _d_clr_wo_ready_T : 32'h0; // @[Monitor.scala 675:91 676:21]
  wire [270:0] _GEN_23 = _d_first_T & d_first_1 & _T_811 ? _d_opcodes_clr_T_5 : 271'h0; // @[Monitor.scala 675:91 677:21]
  wire [270:0] _GEN_24 = _d_first_T & d_first_1 & _T_811 ? _d_sizes_clr_T_5 : 271'h0; // @[Monitor.scala 675:91 678:21]
  wire  _same_cycle_resp_T_2 = io_in_a_bits_source == io_in_d_bits_source; // @[Monitor.scala 681:113]
  wire  same_cycle_resp = _T_798 & io_in_a_bits_source == io_in_d_bits_source; // @[Monitor.scala 681:88]
  wire [18:0] _T_822 = inflight >> io_in_d_bits_source; // @[Monitor.scala 682:25]
  wire  _T_824 = _T_822[0] | same_cycle_resp; // @[Monitor.scala 682:49]
  ...
  wire  _T_829 = io_in_d_bits_opcode == _GEN_40; // @[Monitor.scala 686:39]
  wire  _T_830 = io_in_d_bits_opcode == _GEN_32 | _T_829; // @[Monitor.scala 685:77]
  wire  _T_834 = io_in_a_bits_size == io_in_d_bits_size; // @[Monitor.scala 687:36]
  ...
  wire  _T_841 = io_in_d_bits_opcode == _GEN_56; // @[Monitor.scala 690:38]
  wire  _T_842 = io_in_d_bits_opcode == _GEN_48 | _T_841; // @[Monitor.scala 689:72]
  wire [7:0] a_size_lookup = _a_size_lookup_T_7[7:0];
  wire [7:0] _GEN_79 = {{4'd0}, io_in_d_bits_size}; // @[Monitor.scala 691:36]
  wire  _T_846 = _GEN_79 == a_size_lookup; // @[Monitor.scala 691:36]
  wire  _T_856 = _T_809 & a_first_1 & io_in_a_valid & _same_cycle_resp_T_2 & _T_811; // @[Monitor.scala 694:116]
  wire  _T_858 = ~io_in_d_ready | io_in_a_ready; // @[Monitor.scala 695:32]
  wire [18:0] a_set_wo_ready = _GEN_15[18:0];
  wire [18:0] d_clr_wo_ready = _GEN_21[18:0];
  wire  _T_865 = a_set_wo_ready != d_clr_wo_ready | ~(|a_set_wo_ready); // @[Monitor.scala 699:48]
  ...
  wire  _T_874 = ~(|inflight) | plusarg_reader_out == 32'h0 | watchdog < plusarg_reader_out; // @[Monitor.scala 709:47]
  ...
  wire  _T_900 = io_in_d_valid & d_first_2 & _T_605; // @[Monitor.scala 779:71]
  wire [31:0] _GEN_67 = _d_first_T & d_first_2 & _T_605 ? _d_clr_wo_ready_T : 32'h0; // @[Monitor.scala 783:90 784:21]
  wire [270:0] _GEN_69 = _d_first_T & d_first_2 & _T_605 ? _d_sizes_clr_T_5 : 271'h0; // @[Monitor.scala 783:90 786:21]
  wire [18:0] _T_908 = inflight_1 >> io_in_d_bits_source; // @[Monitor.scala 791:25]
  wire [7:0] c_size_lookup = _c_size_lookup_T_7[7:0];
  wire  _T_918 = _GEN_79 == c_size_lookup; // @[Monitor.scala 795:36]
  ...
  wire  _T_943 = ~(|inflight_1) | plusarg_reader_1_out == 32'h0 | watchdog_1 < plusarg_reader_1_out; // @[Monitor.scala 816:47]
  ...
  always @(posedge clock) begin
    ...
    `ifdef STOP_COND
      if (`STOP_COND) begin
    `endif
        if (~_T_132 & (io_in_a_valid & _T_265 & ~reset)) begin
          $fatal; // @[Monitor.scala 42:11]
        end
    `ifdef STOP_COND
      end
    ...
    `ifdef PRINTF_COND
      if (`PRINTF_COND) begin
    `endif
        if (io_in_a_valid & _T_265 & ~reset & ~_T_132) begin
          $fwrite(32'h80000002,
    ...
    `ifdef STOP_COND
      if (`STOP_COND) begin
    `endif
        if (~_T_471 & (io_in_a_valid & _T_435 & ~reset)) begin
          $fatal; // @[Monitor.scala 42:11]
        end
    `ifdef STOP_COND
      end
    ...
    `ifdef PRINTF_COND
      if (`PRINTF_COND) begin
    `endif
        if (io_in_a_valid & _T_435 & ~reset & ~_T_471) begin
          $fwrite(32'h80000002,
    ...
    `ifdef STOP_COND
      if (`STOP_COND) begin
    `endif
        if (~_T_481 & (io_in_a_valid & _T_435 & ~reset)) begin
          $fatal; // @[Monitor.scala 42:11]
        end
    `ifdef STOP_COND
      end
    ...
    `ifdef PRINTF_COND
      if (`PRINTF_COND) begin
    `endif
        if (io_in_a_valid & _T_435 & ~reset & ~_T_481) begin
          $fwrite(32'h80000002,
    ...
    `ifdef STOP_COND
      if (`STOP_COND) begin
    `endif
        if (~_T_471 & (io_in_a_valid & _T_489 & ~reset)) begin
          $fatal; // @[Monitor.scala 42:11]
        end
    `ifdef STOP_COND
      end
    ...
    `ifdef PRINTF_COND
      if (`PRINTF_COND) begin
    `endif
        if (io_in_a_valid & _T_489 & ~reset & ~_T_471) begin
          $fwrite(32'h80000002,
    ...
    `ifdef STOP_COND
      if (`STOP_COND) begin
    `endif
        if (~_T_535 & (io_in_a_valid & _T_489 & ~reset)) begin
          $fatal; // @[Monitor.scala 42:11]
        end
    `ifdef STOP_COND
      end
    ...
    `ifdef PRINTF_COND
      if (`PRINTF_COND) begin
    `endif
        if (io_in_a_valid & _T_489 & ~reset & ~_T_535) begin
          $fwrite(32'h80000002,
    ...
    `ifdef STOP_COND
      if (`STOP_COND) begin
    `endif
        if (~_T_317 & (io_in_a_valid & _T_489 & ~reset)) begin
          $fatal; // @[Monitor.scala 42:11]
        end
    `ifdef STOP_COND
      end
    ...
    `ifdef PRINTF_COND
      if (`PRINTF_COND) begin
    `endif
        if (io_in_a_valid & _T_489 & ~reset & ~_T_317) begin
          $fwrite(32'h80000002,
    ...
    `ifdef STOP_COND
      if (`STOP_COND) begin
    `endif
        if (~_T_361 & (io_in_a_valid & _T_543 & ~reset)) begin
          $fatal; // @[Monitor.scala 42:11]
        end
    `ifdef STOP_COND
      end
    ...
    `ifdef PRINTF_COND
      if (`PRINTF_COND) begin
    `endif
        if (io_in_a_valid & _T_543 & ~reset & ~_T_361) begin
          $fwrite(32'h80000002,
    ...
    `ifdef STOP_COND
      if (`STOP_COND) begin
    `endif
        if (~_T_589 & (io_in_a_valid & _T_543 & ~reset)) begin
          $fatal; // @[Monitor.scala 42:11]
        end
    `ifdef STOP_COND
      end
    ...
    `ifdef PRINTF_COND
      if (`PRINTF_COND) begin
    `endif
        if (io_in_a_valid & _T_543 & ~reset & ~_T_589) begin
          $fwrite(32'h80000002,
    ...
    `ifdef STOP_COND
      if (`STOP_COND) begin
    `endif
        if (~_T_317 & (io_in_a_valid & _T_543 & ~reset)) begin
          $fatal; // @[Monitor.scala 42:11]
        end
    `ifdef STOP_COND
      end
    ...
    `ifdef PRINTF_COND
      if (`PRINTF_COND) begin
    `endif
        if (io_in_a_valid & _T_543 & ~reset & ~_T_317) begin
          $fwrite(32'h80000002,
    ...
    `ifdef STOP_COND
      if (`STOP_COND) begin
    `endif
        if (~_T_157 & (io_in_a_valid & _T_543 & ~reset)) begin
          $fatal; // @[Monitor.scala 42:11]
        end
    `ifdef STOP_COND
      end
    ...
    `ifdef PRINTF_COND
      if (`PRINTF_COND) begin
    `endif
        if (io_in_a_valid & _T_543 & ~reset & ~_T_157) begin
          $fwrite(32'h80000002,
    ...
    `ifdef STOP_COND
      if (`STOP_COND) begin
    `endif
        if (~_T_601 & (io_in_d_valid & _T_2)) begin
    ...
    `ifdef PRINTF_COND
      if (`PRINTF_COND) begin
    `endif
        if (io_in_d_valid & _T_2 & ~_T_601) begin
          $fwrite(32'h80000002,
    ...
    `ifdef STOP_COND
      if (`STOP_COND) begin
    `endif
        if (~source_ok_1 & (io_in_d_valid & _T_605 & _T_2)) begin
          $fatal; // @[Monitor.scala 49:11]
        end
    `ifdef STOP_COND
      end
    ...
    `ifdef PRINTF_COND
      if (`PRINTF_COND) begin
    `endif
        if (io_in_d_valid & _T_605 & _T_2 & ~source_ok_1) begin
          $fwrite(32'h80000002,
    ...
    `ifdef STOP_COND
      if (`STOP_COND) begin
    `endif
        if (~_T_609 & (io_in_d_valid & _T_605 & _T_2)) begin
          $fatal; // @[Monitor.scala 49:11]
        end
    `ifdef STOP_COND
      end
    ...
    `ifdef PRINTF_COND
      if (`PRINTF_COND) begin
    `endif
        if (io_in_d_valid & _T_605 & _T_2 & ~_T_609) begin
          $fwrite(32'h80000002,
    ...
    `ifdef STOP_COND
      if (`STOP_COND) begin
    `endif
        if (~_T_613 & (io_in_d_valid & _T_605 & _T_2)) begin
          $fatal; // @[Monitor.scala 49:11]
        end
    `ifdef STOP_COND
      end
    ...
    `ifdef PRINTF_COND
      if (`PRINTF_COND) begin
    `endif
        if (io_in_d_valid & _T_605 & _T_2 & ~_T_613) begin
          $fwrite(32'h80000002,
    ...
    `ifdef STOP_COND
      if (`STOP_COND) begin
    `endif
        if (~_T_617 & (io_in_d_valid & _T_605 & _T_2)) begin
          $fatal; // @[Monitor.scala 49:11]
        end
    `ifdef STOP_COND
      end
    ...
    `ifdef PRINTF_COND
      if (`PRINTF_COND) begin
    `endif
        if (io_in_d_valid & _T_605 & _T_2 & ~_T_617) begin
          $fwrite(32'h80000002,
    ...
    `ifdef STOP_COND
      if (`STOP_COND) begin
    `endif
        if (~_T_621 & (io_in_d_valid & _T_605 & _T_2)) begin
          $fatal; // @[Monitor.scala 49:11]
        end
    `ifdef STOP_COND
      end
    ...
    `ifdef PRINTF_COND
      if (`PRINTF_COND) begin
    `endif
        if (io_in_d_valid & _T_605 & _T_2 & ~_T_621) begin
          $fwrite(32'h80000002,
    ...
    `ifdef STOP_COND
      if (`STOP_COND) begin
    `endif
        if (~source_ok_1 & (io_in_d_valid & _T_625 & _T_2)) begin
          $fatal; // @[Monitor.scala 49:11]
        end
    `ifdef STOP_COND
      end
    ...
    `ifdef PRINTF_COND
      if (`PRINTF_COND) begin
    `endif
        if (io_in_d_valid & _T_625 & _T_2 & ~source_ok_1) begin
          $fwrite(32'h80000002,
    ...
    `ifdef STOP_COND
      if (`STOP_COND) begin
    `endif
        if (io_in_d_valid & _T_625 & _T_2) begin
          $fatal; // @[Monitor.scala 49:11]
        end
    `ifdef STOP_COND
      end
    ...
    `ifdef STOP_COND
      if (`STOP_COND) begin
    `endif
        if (~_T_609 & (io_in_d_valid & _T_625 & _T_2)) begin
          $fatal; // @[Monitor.scala 49:11]
        end
    `ifdef STOP_COND
      end
    ...
    `ifdef PRINTF_COND
      if (`PRINTF_COND) begin
    `endif
        if (io_in_d_valid & _T_625 & _T_2 & ~_T_609) begin
          $fwrite(32'h80000002,
    ...
    `ifdef STOP_COND
      if (`STOP_COND) begin
    `endif
        if (~_T_636 & (io_in_d_valid & _T_625 & _T_2)) begin
          $fatal; // @[Monitor.scala 49:11]
        end
    `ifdef STOP_COND
      end
    ...
    `ifdef PRINTF_COND
      if (`PRINTF_COND) begin
    `endif
        if (io_in_d_valid & _T_625 & _T_2 & ~_T_636) begin
          $fwrite(32'h80000002,
    ...
    `ifdef STOP_COND
      if (`STOP_COND) begin
    `endif
        if (~_T_640 & (io_in_d_valid & _T_625 & _T_2)) begin
          $fatal; // @[Monitor.scala 49:11]
        end
    `ifdef STOP_COND
      end
    ...
    `ifdef PRINTF_COND
      if (`PRINTF_COND) begin
    `endif
        if (io_in_d_valid & _T_625 & _T_2 & ~_T_640) begin
          $fwrite(32'h80000002,
    ...
    `ifdef STOP_COND
      if (`STOP_COND) begin
    `endif
        if (~_T_617 & (io_in_d_valid & _T_625 & _T_2)) begin
          $fatal; // @[Monitor.scala 49:11]
        end
    `ifdef STOP_COND
      end
    ...
    `ifdef PRINTF_COND
      if (`PRINTF_COND) begin
    `endif
        if (io_in_d_valid & _T_625 & _T_2 & ~_T_617) begin
          $fwrite(32'h80000002,
    ...
    `ifdef STOP_COND
      if (`STOP_COND) begin
    `endif
        if (~source_ok_1 & (io_in_d_valid & _T_653 & _T_2)) begin
          $fatal; // @[Monitor.scala 49:11]
        end
    `ifdef STOP_COND
      end
    ...
    `ifdef PRINTF_COND
      if (`PRINTF_COND) begin
    `endif
        if (io_in_d_valid & _T_653 & _T_2 & ~source_ok_1) begin
          $fwrite(32'h80000002,
    ...
    `ifdef STOP_COND
      if (`STOP_COND) begin
    `endif
        if (io_in_d_valid & _T_653 & _T_2) begin
          $fatal; // @[Monitor.scala 49:11]
        end
    `ifdef STOP_COND
      end
    ...
    `ifdef STOP_COND
      if (`STOP_COND) begin
    `endif
        if (~_T_609 & (io_in_d_valid & _T_653 & _T_2)) begin
          $fatal; // @[Monitor.scala 49:11]
        end
    `ifdef STOP_COND
      end
    ...
    `ifdef PRINTF_COND
      if (`PRINTF_COND) begin
    `endif
        if (io_in_d_valid & _T_653 & _T_2 & ~_T_609) begin
          $fwrite(32'h80000002,
    ...
    `ifdef STOP_COND
      if (`STOP_COND) begin
    `endif
        if (~_T_636 & (io_in_d_valid & _T_653 & _T_2)) begin
          $fatal; // @[Monitor.scala 49:11]
        end
    `ifdef STOP_COND
      end
    ...
    `ifdef PRINTF_COND
      if (`PRINTF_COND) begin
    `endif
        if (io_in_d_valid & _T_653 & _T_2 & ~_T_636) begin
          $fwrite(32'h80000002,
    ...
    `ifdef STOP_COND
      if (`STOP_COND) begin
    `endif
        if (~_T_640 & (io_in_d_valid & _T_653 & _T_2)) begin
          $fatal; // @[Monitor.scala 49:11]
        end
    `ifdef STOP_COND
      end
    ...
    `ifdef PRINTF_COND
      if (`PRINTF_COND) begin
    `endif
        if (io_in_d_valid & _T_653 & _T_2 & ~_T_640) begin
          $fwrite(32'h80000002,
    ...
    `ifdef STOP_COND
      if (`STOP_COND) begin
    `endif
        if (~_T_673 & (io_in_d_valid & _T_653 & _T_2)) begin
          $fatal; // @[Monitor.scala 49:11]
        end
    `ifdef STOP_COND
      end
    ...
    `ifdef PRINTF_COND
      if (`PRINTF_COND) begin
    `endif
        if (io_in_d_valid & _T_653 & _T_2 & ~_T_673) begin
          $fwrite(32'h80000002,
    ...
    `ifdef STOP_COND
      if (`STOP_COND) begin
    `endif
        if (~source_ok_1 & (io_in_d_valid & _T_682 & _T_2)) begin
          $fatal; // @[Monitor.scala 49:11]
        end
    `ifdef STOP_COND
      end
    ...
    `ifdef PRINTF_COND
      if (`PRINTF_COND) begin
    `endif
        if (io_in_d_valid & _T_682 & _T_2 & ~source_ok_1) begin
          $fwrite(32'h80000002,
    ...
    `ifdef STOP_COND
      if (`STOP_COND) begin
    `endif
        if (~_T_613 & (io_in_d_valid & _T_682 & _T_2)) begin
          $fatal; // @[Monitor.scala 49:11]
        end
    `ifdef STOP_COND
      end
    ...
    `ifdef PRINTF_COND
      if (`PRINTF_COND) begin
    `endif
        if (io_in_d_valid & _T_682 & _T_2 & ~_T_613) begin
          $fwrite(32'h80000002,
    ...
    `ifdef STOP_COND
      if (`STOP_COND) begin
    `endif
        if (~_T_617 & (io_in_d_valid & _T_682 & _T_2)) begin
          $fatal; // @[Monitor.scala 49:11]
        end
    `ifdef STOP_COND
      end
    ...
    `ifdef PRINTF_COND
      if (`PRINTF_COND) begin
    `endif
        if (io_in_d_valid & _T_682 & _T_2 & ~_T_617) begin
          $fwrite(32'h80000002,
    ...
    `ifdef STOP_COND
      if (`STOP_COND) begin
    `endif
        if (~source_ok_1 & (io_in_d_valid & _T_699 & _T_2)) begin
          $fatal; // @[Monitor.scala 49:11]
        end
    `ifdef STOP_COND
      end
    ...
    `ifdef PRINTF_COND
      if (`PRINTF_COND) begin
    `endif
        if (io_in_d_valid & _T_699 & _T_2 & ~source_ok_1) begin
          $fwrite(32'h80000002,
    ...
    `ifdef STOP_COND
      if (`STOP_COND) begin
    `endif
        if (~_T_613 & (io_in_d_valid & _T_699 & _T_2)) begin
          $fatal; // @[Monitor.scala 49:11]
        end
    `ifdef STOP_COND
      end
    ...
    `ifdef PRINTF_COND
      if (`PRINTF_COND) begin
    `endif
        if (io_in_d_valid & _T_699 & _T_2 & ~_T_613) begin
          $fwrite(32'h80000002,
    ...
    `ifdef STOP_COND
      if (`STOP_COND) begin
    `endif
        if (~_T_673 & (io_in_d_valid & _T_699 & _T_2)) begin
          $fatal; // @[Monitor.scala 49:11]
        end
    `ifdef STOP_COND
      end
    ...
    `ifdef PRINTF_COND
      if (`PRINTF_COND) begin
    `endif
        if (io_in_d_valid & _T_699 & _T_2 & ~_T_673) begin
          $fwrite(32'h80000002,
    ...
    `ifdef STOP_COND
      if (`STOP_COND) begin
    `endif
        if (~source_ok_1 & (io_in_d_valid & _T_717 & _T_2)) begin
          $fatal; // @[Monitor.scala 49:11]
        end
    `ifdef STOP_COND
      end
    ...
    `ifdef PRINTF_COND
      if (`PRINTF_COND) begin
    `endif
        if (io_in_d_valid & _T_717 & _T_2 & ~source_ok_1) begin
          $fwrite(32'h80000002,
    ...
    `ifdef STOP_COND
      if (`STOP_COND) begin
    `endif
        if (~_T_613 & (io_in_d_valid & _T_717 & _T_2)) begin
          $fatal; // @[Monitor.scala 49:11]
        end
    `ifdef STOP_COND
      end
    ...
    `ifdef PRINTF_COND
      if (`PRINTF_COND) begin
    `endif
        if (io_in_d_valid & _T_717 & _T_2 & ~_T_613) begin
          $fwrite(32'h80000002,
    ...
    `ifdef STOP_COND
      if (`STOP_COND) begin
    `endif
        if (~_T_617 & (io_in_d_valid & _T_717 & _T_2)) begin
          $fatal; // @[Monitor.scala 49:11]
        end
    `ifdef STOP_COND
      end
    ...
    `ifdef PRINTF_COND
      if (`PRINTF_COND) begin
    `endif
        if (io_in_d_valid & _T_717 & _T_2 & ~_T_617) begin
          $fwrite(32'h80000002,
    ...
    `ifdef STOP_COND
      if (`STOP_COND) begin
    `endif
        if (~_T_830 & (_T_812 & same_cycle_resp & _T_2)) begin
          $fatal; // @[Monitor.scala 49:11]
        end
    `ifdef STOP_COND
      end
    ...
    `ifdef PRINTF_COND
      if (`PRINTF_COND) begin
    `endif
        if (_T_812 & same_cycle_resp & _T_2 & ~_T_830) begin
          $fwrite(32'h80000002,
    ...
    `ifdef STOP_COND
      if (`STOP_COND) begin
    `endif
        if (~_T_834 & (_T_812 & same_cycle_resp & _T_2)) begin
          $fatal; // @[Monitor.scala 49:11]
        end
    `ifdef STOP_COND
      end
    ...
    `ifdef PRINTF_COND
      if (`PRINTF_COND) begin
    `endif
        if (_T_812 & same_cycle_resp & _T_2 & ~_T_834) begin
          $fwrite(32'h80000002,
    ...
    `ifdef STOP_COND
      if (`STOP_COND) begin
    `endif
        if (~_T_842 & (_T_812 & ~same_cycle_resp & _T_2)) begin
          $fatal; // @[Monitor.scala 49:11]
        end
    `ifdef STOP_COND
      end
    ...
    `ifdef PRINTF_COND
      if (`PRINTF_COND) begin
    `endif
        if (_T_812 & ~same_cycle_resp & _T_2 & ~_T_842) begin
          $fwrite(32'h80000002,
            "Assertion failed: 'D' channel contains improper opcode response (connected at CanHaveBuiltInDevices.scala:44:9)\n    at Monitor.scala:49 assert(cond, message)\n"
            ); // @[Monitor.scala 49:11]
        end
    ...
    `ifdef STOP_COND
      if (`STOP_COND) begin
    `endif
        if (~_T_846 & (_T_812 & ~same_cycle_resp & _T_2)) begin
          $fatal; // @[Monitor.scala 49:11]
        end
    `ifdef STOP_COND
      end
    ...
    `ifdef PRINTF_COND
      if (`PRINTF_COND) begin
    `endif
        if (_T_812 & ~same_cycle_resp & _T_2 & ~_T_846) begin
          $fwrite(32'h80000002,
            "Assertion failed: 'D' channel contains improper response size (connected at CanHaveBuiltInDevices.scala:44:9)\n    at Monitor.scala:49 assert(cond, message)\n"
            ); // @[Monitor.scala 49:11]
        end
