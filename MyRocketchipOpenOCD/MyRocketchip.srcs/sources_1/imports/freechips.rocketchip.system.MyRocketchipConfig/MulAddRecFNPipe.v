...
`endif // RANDOMIZE_REG_INIT
  ...
  wire [32:0] mulAddRecFNToRaw_preMul_io_a; // @[FPU.scala 647:41]
  wire [32:0] mulAddRecFNToRaw_preMul_io_b; // @[FPU.scala 647:41]
  wire [32:0] mulAddRecFNToRaw_preMul_io_c; // @[FPU.scala 647:41]
  wire [23:0] mulAddRecFNToRaw_preMul_io_mulAddA; // @[FPU.scala 647:41]
  wire [23:0] mulAddRecFNToRaw_preMul_io_mulAddB; // @[FPU.scala 647:41]
  wire [47:0] mulAddRecFNToRaw_preMul_io_mulAddC; // @[FPU.scala 647:41]
  ...
  wire [9:0] mulAddRecFNToRaw_preMul_io_toPostMul_sExpSum; // @[FPU.scala 647:41]
  ...
  wire [4:0] mulAddRecFNToRaw_preMul_io_toPostMul_CDom_CAlignDist; // @[FPU.scala 647:41]
  wire [25:0] mulAddRecFNToRaw_preMul_io_toPostMul_highAlignedSigC; // @[FPU.scala 647:41]
  ...
  wire [9:0] mulAddRecFNToRaw_postMul_io_fromPreMul_sExpSum; // @[FPU.scala 648:42]
  ...
  wire [4:0] mulAddRecFNToRaw_postMul_io_fromPreMul_CDom_CAlignDist; // @[FPU.scala 648:42]
  wire [25:0] mulAddRecFNToRaw_postMul_io_fromPreMul_highAlignedSigC; // @[FPU.scala 648:42]
  wire  mulAddRecFNToRaw_postMul_io_fromPreMul_bit0AlignedSigC; // @[FPU.scala 648:42]
  wire [48:0] mulAddRecFNToRaw_postMul_io_mulAddResult; // @[FPU.scala 648:42]
  ...
  wire [9:0] mulAddRecFNToRaw_postMul_io_rawOut_sExp; // @[FPU.scala 648:42]
  wire [26:0] mulAddRecFNToRaw_postMul_io_rawOut_sig; // @[FPU.scala 648:42]
  ...
  wire [9:0] roundRawFNToRecFN_io_in_sExp; // @[FPU.scala 675:35]
  wire [26:0] roundRawFNToRecFN_io_in_sig; // @[FPU.scala 675:35]
  wire [2:0] roundRawFNToRecFN_io_roundingMode; // @[FPU.scala 675:35]
  wire [32:0] roundRawFNToRecFN_io_out; // @[FPU.scala 675:35]
  wire [4:0] roundRawFNToRecFN_io_exceptionFlags; // @[FPU.scala 675:35]
  wire [47:0] _mulAddResult_T = mulAddRecFNToRaw_preMul_io_mulAddA * mulAddRecFNToRaw_preMul_io_mulAddB; // @[FPU.scala 656:45]
  wire [48:0] mulAddResult = _mulAddResult_T + mulAddRecFNToRaw_preMul_io_mulAddC; // @[FPU.scala 657:50]
  ...
  reg [9:0] mulAddRecFNToRaw_postMul_io_fromPreMul_b_sExpSum; // @[Reg.scala 16:16]
  ...
  reg [4:0] mulAddRecFNToRaw_postMul_io_fromPreMul_b_CDom_CAlignDist; // @[Reg.scala 16:16]
  reg [25:0] mulAddRecFNToRaw_postMul_io_fromPreMul_b_highAlignedSigC; // @[Reg.scala 16:16]
  reg  mulAddRecFNToRaw_postMul_io_fromPreMul_b_bit0AlignedSigC; // @[Reg.scala 16:16]
  reg [48:0] mulAddRecFNToRaw_postMul_io_mulAddResult_b; // @[Reg.scala 16:16]
  ...
  reg [9:0] roundRawFNToRecFN_io_in_b_sExp; // @[Reg.scala 16:16]
  reg [26:0] roundRawFNToRecFN_io_in_b_sig; // @[Reg.scala 16:16]
  reg [2:0] roundRawFNToRecFN_io_roundingMode_b; // @[Reg.scala 16:16]
  MulAddRecFNToRaw_preMul mulAddRecFNToRaw_preMul ( // @[FPU.scala 647:41]
  ...
  MulAddRecFNToRaw_postMul mulAddRecFNToRaw_postMul ( // @[FPU.scala 648:42]
  ...
  RoundRawFNToRecFN roundRawFNToRecFN ( // @[FPU.scala 675:35]
