...
`endif // RANDOMIZE_REG_INIT
  reg [6:0] ram_id [0:0]; // @[Decoupled.scala 259:95]
  wire  ram_id_io_deq_bits_MPORT_en; // @[Decoupled.scala 259:95]
  wire  ram_id_io_deq_bits_MPORT_addr; // @[Decoupled.scala 259:95]
  wire [6:0] ram_id_io_deq_bits_MPORT_data; // @[Decoupled.scala 259:95]
  wire [6:0] ram_id_MPORT_data; // @[Decoupled.scala 259:95]
  ...
  reg [6:0] ram_echo_tl_state_source [0:0]; // @[Decoupled.scala 259:95]
  ...
  wire [6:0] ram_echo_tl_state_source_io_deq_bits_MPORT_data; // @[Decoupled.scala 259:95]
  wire [6:0] ram_echo_tl_state_source_MPORT_data; // @[Decoupled.scala 259:95]
