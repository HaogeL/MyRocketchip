...
`endif // RANDOMIZE_REG_INIT
  ...
  wire  _T_967 = io_in_b_bits_opcode <= 3'h6; // @[Bundles.scala 40:24]
  wire  _T_971 = io_in_b_bits_source == 2'h0; // @[Parameters.scala 46:9]
  wire [32:0] _T_974 = {1'b0,$signed(io_in_b_bits_address)}; // @[Parameters.scala 137:49]
  wire  _T_979 = io_in_b_bits_source == 2'h1; // @[Parameters.scala 46:9]
  wire  _T_987 = io_in_b_bits_source == 2'h2; // @[Parameters.scala 46:9]
  ...
  wire [1:0] _legal_source_T_5 = _T_987 ? 2'h2 : 2'h0; // @[Mux.scala 27:73]
  wire [1:0] _GEN_88 = {{1'd0}, _T_979}; // @[Mux.scala 27:73]
  ...
  wire  _T_1000 = io_in_b_bits_opcode == 3'h6; // @[Monitor.scala 167:25]
  wire  _T_1004 = 4'h6 == io_in_b_bits_size; // @[Parameters.scala 91:48]
  wire  _T_1005 = _T_971 & _T_1004; // @[Mux.scala 27:73]
  wire  _T_1011 = io_in_b_bits_size <= 4'hc; // @[Parameters.scala 92:42]
  ...
  wire  _T_1055 = _T_1011 & _T_1054; // @[Parameters.scala 670:56]
  wire  _T_1057 = _T_1005 & _T_1055; // @[Monitor.scala 168:75]
  wire  _T_1063 = ~address_ok; // @[Monitor.scala 49:11]
  wire  _T_1066 = ~legal_source; // @[Monitor.scala 49:11]
  wire  _T_1069 = ~is_aligned_1; // @[Monitor.scala 49:11]
  wire  _T_1070 = io_in_b_bits_param <= 2'h2; // @[Bundles.scala 102:26]
  wire  _T_1074 = io_in_b_bits_mask == mask_1; // @[Monitor.scala 173:27]
  wire  _T_1077 = ~_T_1074; // @[Monitor.scala 49:11]
  wire  _T_1078 = ~io_in_b_bits_corrupt; // @[Monitor.scala 174:15]
  wire  _T_1081 = ~_T_1078; // @[Monitor.scala 49:11]
  wire  _T_1082 = io_in_b_bits_opcode == 3'h4; // @[Monitor.scala 177:25]
  wire  _T_1143 = io_in_b_bits_param == 2'h0; // @[Monitor.scala 182:31]
  wire  _T_1155 = io_in_b_bits_opcode == 3'h0; // @[Monitor.scala 187:25]
  wire  _T_1224 = io_in_b_bits_opcode == 3'h1; // @[Monitor.scala 196:25]
  wire [7:0] _T_1289 = ~mask_1; // @[Monitor.scala 202:33]
  wire [7:0] _T_1290 = io_in_b_bits_mask & _T_1289; // @[Monitor.scala 202:31]
  wire  _T_1291 = _T_1290 == 8'h0; // @[Monitor.scala 202:40]
  wire  _T_1295 = io_in_b_bits_opcode == 3'h2; // @[Monitor.scala 205:25]
  wire  _T_1364 = io_in_b_bits_opcode == 3'h3; // @[Monitor.scala 214:25]
  wire  _T_1433 = io_in_b_bits_opcode == 3'h5; // @[Monitor.scala 223:25]
  ...
  wire  _T_1962 = io_in_b_bits_opcode == opcode_2; // @[Monitor.scala 413:32]
  wire  _T_1966 = io_in_b_bits_param == param_2; // @[Monitor.scala 414:32]
  wire  _T_1970 = io_in_b_bits_size == size_2; // @[Monitor.scala 415:32]
  wire  _T_1974 = io_in_b_bits_source == source_2; // @[Monitor.scala 416:32]
  ...
  wire  _T_2056 = _GEN_97 == a_size_lookup; // @[Monitor.scala 691:36]
  ...
  wire  _T_2128 = _GEN_97 == c_size_lookup; // @[Monitor.scala 795:36]
  ...
  wire  _T_2173 = io_in_e_ready & io_in_e_valid; // @[Decoupled.scala 50:35]
  ...
  wire [3:0] e_clr = _T_2173 ? _e_clr_T : 4'h0; // @[Monitor.scala 835:73 836:13]
  ...
  always @(posedge clock) begin
    ...
    `ifdef STOP_COND
      if (`STOP_COND) begin
    `endif
        if (~_T_967 & (io_in_b_valid & ~reset)) begin
          $fatal; // @[Monitor.scala 42:11]
        end
    `ifdef STOP_COND
      end
    ...
    `ifdef PRINTF_COND
      if (`PRINTF_COND) begin
    `endif
        if (io_in_b_valid & ~reset & ~_T_967) begin
          $fwrite(32'h80000002,
    ...
    `ifdef STOP_COND
      if (`STOP_COND) begin
    `endif
        if (~_T_1057 & (io_in_b_valid & _T_1000 & _T_2)) begin
          $fatal; // @[Monitor.scala 49:11]
        end
    `ifdef STOP_COND
      end
    ...
    `ifdef PRINTF_COND
      if (`PRINTF_COND) begin
    `endif
        if (io_in_b_valid & _T_1000 & _T_2 & ~_T_1057) begin
          $fwrite(32'h80000002,
    ...
    `ifdef STOP_COND
      if (`STOP_COND) begin
    `endif
        if (~address_ok & (io_in_b_valid & _T_1000 & _T_2)) begin
          $fatal; // @[Monitor.scala 49:11]
        end
    `ifdef STOP_COND
      end
    ...
    `ifdef PRINTF_COND
      if (`PRINTF_COND) begin
    `endif
        if (io_in_b_valid & _T_1000 & _T_2 & ~address_ok) begin
          $fwrite(32'h80000002,
    ...
    `ifdef STOP_COND
      if (`STOP_COND) begin
    `endif
        if (~legal_source & (io_in_b_valid & _T_1000 & _T_2)) begin
          $fatal; // @[Monitor.scala 49:11]
        end
    `ifdef STOP_COND
      end
    ...
    `ifdef PRINTF_COND
      if (`PRINTF_COND) begin
    `endif
        if (io_in_b_valid & _T_1000 & _T_2 & ~legal_source) begin
          $fwrite(32'h80000002,
    ...
    `ifdef STOP_COND
      if (`STOP_COND) begin
    `endif
        if (~is_aligned_1 & (io_in_b_valid & _T_1000 & _T_2)) begin
          $fatal; // @[Monitor.scala 49:11]
        end
    `ifdef STOP_COND
      end
    ...
    `ifdef PRINTF_COND
      if (`PRINTF_COND) begin
    `endif
        if (io_in_b_valid & _T_1000 & _T_2 & ~is_aligned_1) begin
          $fwrite(32'h80000002,
    ...
    `ifdef STOP_COND
      if (`STOP_COND) begin
    `endif
        if (~_T_1070 & (io_in_b_valid & _T_1000 & _T_2)) begin
          $fatal; // @[Monitor.scala 49:11]
        end
    `ifdef STOP_COND
      end
    ...
    `ifdef PRINTF_COND
      if (`PRINTF_COND) begin
    `endif
        if (io_in_b_valid & _T_1000 & _T_2 & ~_T_1070) begin
          $fwrite(32'h80000002,
    ...
    `ifdef STOP_COND
      if (`STOP_COND) begin
    `endif
        if (~_T_1074 & (io_in_b_valid & _T_1000 & _T_2)) begin
          $fatal; // @[Monitor.scala 49:11]
        end
    `ifdef STOP_COND
      end
    ...
    `ifdef PRINTF_COND
      if (`PRINTF_COND) begin
    `endif
        if (io_in_b_valid & _T_1000 & _T_2 & ~_T_1074) begin
          $fwrite(32'h80000002,
    ...
    `ifdef STOP_COND
      if (`STOP_COND) begin
    `endif
        if (~_T_1078 & (io_in_b_valid & _T_1000 & _T_2)) begin
          $fatal; // @[Monitor.scala 49:11]
        end
    `ifdef STOP_COND
      end
    ...
    `ifdef PRINTF_COND
      if (`PRINTF_COND) begin
    `endif
        if (io_in_b_valid & _T_1000 & _T_2 & ~_T_1078) begin
          $fwrite(32'h80000002,
    ...
    `ifdef STOP_COND
      if (`STOP_COND) begin
    `endif
        if (io_in_b_valid & _T_1082 & ~reset) begin
          $fatal; // @[Monitor.scala 42:11]
        end
    `ifdef STOP_COND
      end
    ...
    `ifdef STOP_COND
      if (`STOP_COND) begin
    `endif
        if (_T_1063 & (io_in_b_valid & _T_1082 & ~reset)) begin
          $fatal; // @[Monitor.scala 42:11]
        end
    `ifdef STOP_COND
      end
    ...
    `ifdef PRINTF_COND
      if (`PRINTF_COND) begin
    `endif
        if (io_in_b_valid & _T_1082 & ~reset & _T_1063) begin
          $fwrite(32'h80000002,
    ...
    `ifdef STOP_COND
      if (`STOP_COND) begin
    `endif
        if (_T_1066 & (io_in_b_valid & _T_1082 & ~reset)) begin
          $fatal; // @[Monitor.scala 42:11]
        end
    `ifdef STOP_COND
      end
    ...
    `ifdef PRINTF_COND
      if (`PRINTF_COND) begin
    `endif
        if (io_in_b_valid & _T_1082 & ~reset & _T_1066) begin
          $fwrite(32'h80000002,
    ...
    `ifdef STOP_COND
      if (`STOP_COND) begin
    `endif
        if (_T_1069 & (io_in_b_valid & _T_1082 & ~reset)) begin
          $fatal; // @[Monitor.scala 42:11]
        end
    `ifdef STOP_COND
      end
    ...
    `ifdef PRINTF_COND
      if (`PRINTF_COND) begin
    `endif
        if (io_in_b_valid & _T_1082 & ~reset & _T_1069) begin
          $fwrite(32'h80000002,
    ...
    `ifdef STOP_COND
      if (`STOP_COND) begin
    `endif
        if (~_T_1143 & (io_in_b_valid & _T_1082 & ~reset)) begin
          $fatal; // @[Monitor.scala 42:11]
        end
    `ifdef STOP_COND
      end
    ...
    `ifdef PRINTF_COND
      if (`PRINTF_COND) begin
    `endif
        if (io_in_b_valid & _T_1082 & ~reset & ~_T_1143) begin
          $fwrite(32'h80000002,
    ...
    `ifdef STOP_COND
      if (`STOP_COND) begin
    `endif
        if (_T_1077 & (io_in_b_valid & _T_1082 & ~reset)) begin
          $fatal; // @[Monitor.scala 42:11]
        end
    `ifdef STOP_COND
      end
    ...
    `ifdef PRINTF_COND
      if (`PRINTF_COND) begin
    `endif
        if (io_in_b_valid & _T_1082 & ~reset & _T_1077) begin
          $fwrite(32'h80000002,
    ...
    `ifdef STOP_COND
      if (`STOP_COND) begin
    `endif
        if (_T_1081 & (io_in_b_valid & _T_1082 & ~reset)) begin
          $fatal; // @[Monitor.scala 42:11]
        end
    `ifdef STOP_COND
      end
    ...
    `ifdef PRINTF_COND
      if (`PRINTF_COND) begin
    `endif
        if (io_in_b_valid & _T_1082 & ~reset & _T_1081) begin
          $fwrite(32'h80000002,
    ...
    `ifdef STOP_COND
      if (`STOP_COND) begin
    `endif
        if (io_in_b_valid & _T_1155 & ~reset) begin
          $fatal; // @[Monitor.scala 42:11]
        end
    `ifdef STOP_COND
      end
    ...
    `ifdef STOP_COND
      if (`STOP_COND) begin
    `endif
        if (_T_1063 & (io_in_b_valid & _T_1155 & ~reset)) begin
          $fatal; // @[Monitor.scala 42:11]
        end
    `ifdef STOP_COND
      end
    ...
    `ifdef PRINTF_COND
      if (`PRINTF_COND) begin
    `endif
        if (io_in_b_valid & _T_1155 & ~reset & _T_1063) begin
          $fwrite(32'h80000002,
    ...
    `ifdef STOP_COND
      if (`STOP_COND) begin
    `endif
        if (_T_1066 & (io_in_b_valid & _T_1155 & ~reset)) begin
          $fatal; // @[Monitor.scala 42:11]
        end
    `ifdef STOP_COND
      end
    ...
    `ifdef PRINTF_COND
      if (`PRINTF_COND) begin
    `endif
        if (io_in_b_valid & _T_1155 & ~reset & _T_1066) begin
          $fwrite(32'h80000002,
    ...
    `ifdef STOP_COND
      if (`STOP_COND) begin
    `endif
        if (_T_1069 & (io_in_b_valid & _T_1155 & ~reset)) begin
          $fatal; // @[Monitor.scala 42:11]
        end
    `ifdef STOP_COND
      end
    ...
    `ifdef PRINTF_COND
      if (`PRINTF_COND) begin
    `endif
        if (io_in_b_valid & _T_1155 & ~reset & _T_1069) begin
          $fwrite(32'h80000002,
    ...
    `ifdef STOP_COND
      if (`STOP_COND) begin
    `endif
        if (~_T_1143 & (io_in_b_valid & _T_1155 & ~reset)) begin
          $fatal; // @[Monitor.scala 42:11]
        end
    `ifdef STOP_COND
      end
    ...
    `ifdef PRINTF_COND
      if (`PRINTF_COND) begin
    `endif
        if (io_in_b_valid & _T_1155 & ~reset & ~_T_1143) begin
          $fwrite(32'h80000002,
    ...
    `ifdef STOP_COND
      if (`STOP_COND) begin
    `endif
        if (_T_1077 & (io_in_b_valid & _T_1155 & ~reset)) begin
          $fatal; // @[Monitor.scala 42:11]
        end
    `ifdef STOP_COND
      end
    ...
    `ifdef PRINTF_COND
      if (`PRINTF_COND) begin
    `endif
        if (io_in_b_valid & _T_1155 & ~reset & _T_1077) begin
          $fwrite(32'h80000002,
    ...
    `ifdef STOP_COND
      if (`STOP_COND) begin
    `endif
        if (io_in_b_valid & _T_1224 & ~reset) begin
          $fatal; // @[Monitor.scala 42:11]
        end
    `ifdef STOP_COND
      end
    ...
    `ifdef STOP_COND
      if (`STOP_COND) begin
    `endif
        if (_T_1063 & (io_in_b_valid & _T_1224 & ~reset)) begin
          $fatal; // @[Monitor.scala 42:11]
        end
    `ifdef STOP_COND
      end
    ...
    `ifdef PRINTF_COND
      if (`PRINTF_COND) begin
    `endif
        if (io_in_b_valid & _T_1224 & ~reset & _T_1063) begin
          $fwrite(32'h80000002,
    ...
    `ifdef STOP_COND
      if (`STOP_COND) begin
    `endif
        if (_T_1066 & (io_in_b_valid & _T_1224 & ~reset)) begin
          $fatal; // @[Monitor.scala 42:11]
        end
    `ifdef STOP_COND
      end
    ...
    `ifdef PRINTF_COND
      if (`PRINTF_COND) begin
    `endif
        if (io_in_b_valid & _T_1224 & ~reset & _T_1066) begin
          $fwrite(32'h80000002,
    ...
    `ifdef STOP_COND
      if (`STOP_COND) begin
    `endif
        if (_T_1069 & (io_in_b_valid & _T_1224 & ~reset)) begin
          $fatal; // @[Monitor.scala 42:11]
        end
    `ifdef STOP_COND
      end
    ...
    `ifdef PRINTF_COND
      if (`PRINTF_COND) begin
    `endif
        if (io_in_b_valid & _T_1224 & ~reset & _T_1069) begin
          $fwrite(32'h80000002,
    ...
    `ifdef STOP_COND
      if (`STOP_COND) begin
    `endif
        if (~_T_1143 & (io_in_b_valid & _T_1224 & ~reset)) begin
          $fatal; // @[Monitor.scala 42:11]
        end
    `ifdef STOP_COND
      end
    ...
    `ifdef PRINTF_COND
      if (`PRINTF_COND) begin
    `endif
        if (io_in_b_valid & _T_1224 & ~reset & ~_T_1143) begin
          $fwrite(32'h80000002,
    ...
    `ifdef STOP_COND
      if (`STOP_COND) begin
    `endif
        if (~_T_1291 & (io_in_b_valid & _T_1224 & ~reset)) begin
          $fatal; // @[Monitor.scala 42:11]
        end
    `ifdef STOP_COND
      end
    ...
    `ifdef PRINTF_COND
      if (`PRINTF_COND) begin
    `endif
        if (io_in_b_valid & _T_1224 & ~reset & ~_T_1291) begin
          $fwrite(32'h80000002,
    ...
    `ifdef STOP_COND
      if (`STOP_COND) begin
    `endif
        if (io_in_b_valid & _T_1295 & ~reset) begin
          $fatal; // @[Monitor.scala 42:11]
        end
    `ifdef STOP_COND
      end
    ...
    `ifdef STOP_COND
      if (`STOP_COND) begin
    `endif
        if (_T_1063 & (io_in_b_valid & _T_1295 & ~reset)) begin
          $fatal; // @[Monitor.scala 42:11]
        end
    `ifdef STOP_COND
      end
    ...
    `ifdef PRINTF_COND
      if (`PRINTF_COND) begin
    `endif
        if (io_in_b_valid & _T_1295 & ~reset & _T_1063) begin
          $fwrite(32'h80000002,
    ...
    `ifdef STOP_COND
      if (`STOP_COND) begin
    `endif
        if (_T_1066 & (io_in_b_valid & _T_1295 & ~reset)) begin
          $fatal; // @[Monitor.scala 42:11]
        end
    `ifdef STOP_COND
      end
    ...
    `ifdef PRINTF_COND
      if (`PRINTF_COND) begin
    `endif
        if (io_in_b_valid & _T_1295 & ~reset & _T_1066) begin
          $fwrite(32'h80000002,
    ...
    `ifdef STOP_COND
      if (`STOP_COND) begin
    `endif
        if (_T_1069 & (io_in_b_valid & _T_1295 & ~reset)) begin
          $fatal; // @[Monitor.scala 42:11]
        end
    `ifdef STOP_COND
      end
    ...
    `ifdef PRINTF_COND
      if (`PRINTF_COND) begin
    `endif
        if (io_in_b_valid & _T_1295 & ~reset & _T_1069) begin
          $fwrite(32'h80000002,
    ...
    `ifdef STOP_COND
      if (`STOP_COND) begin
    `endif
        if (_T_1077 & (io_in_b_valid & _T_1295 & ~reset)) begin
          $fatal; // @[Monitor.scala 42:11]
        end
    `ifdef STOP_COND
      end
    ...
    `ifdef PRINTF_COND
      if (`PRINTF_COND) begin
    `endif
        if (io_in_b_valid & _T_1295 & ~reset & _T_1077) begin
          $fwrite(32'h80000002,
    ...
    `ifdef STOP_COND
      if (`STOP_COND) begin
    `endif
        if (io_in_b_valid & _T_1364 & ~reset) begin
          $fatal; // @[Monitor.scala 42:11]
        end
    `ifdef STOP_COND
      end
    ...
    `ifdef STOP_COND
      if (`STOP_COND) begin
    `endif
        if (_T_1063 & (io_in_b_valid & _T_1364 & ~reset)) begin
          $fatal; // @[Monitor.scala 42:11]
        end
    `ifdef STOP_COND
      end
    ...
    `ifdef PRINTF_COND
      if (`PRINTF_COND) begin
    `endif
        if (io_in_b_valid & _T_1364 & ~reset & _T_1063) begin
          $fwrite(32'h80000002,
    ...
    `ifdef STOP_COND
      if (`STOP_COND) begin
    `endif
        if (_T_1066 & (io_in_b_valid & _T_1364 & ~reset)) begin
          $fatal; // @[Monitor.scala 42:11]
        end
    `ifdef STOP_COND
      end
    ...
    `ifdef PRINTF_COND
      if (`PRINTF_COND) begin
    `endif
        if (io_in_b_valid & _T_1364 & ~reset & _T_1066) begin
          $fwrite(32'h80000002,
    ...
    `ifdef STOP_COND
      if (`STOP_COND) begin
    `endif
        if (_T_1069 & (io_in_b_valid & _T_1364 & ~reset)) begin
          $fatal; // @[Monitor.scala 42:11]
        end
    `ifdef STOP_COND
      end
    ...
    `ifdef PRINTF_COND
      if (`PRINTF_COND) begin
    `endif
        if (io_in_b_valid & _T_1364 & ~reset & _T_1069) begin
          $fwrite(32'h80000002,
    ...
    `ifdef STOP_COND
      if (`STOP_COND) begin
    `endif
        if (_T_1077 & (io_in_b_valid & _T_1364 & ~reset)) begin
          $fatal; // @[Monitor.scala 42:11]
        end
    `ifdef STOP_COND
      end
    ...
    `ifdef PRINTF_COND
      if (`PRINTF_COND) begin
    `endif
        if (io_in_b_valid & _T_1364 & ~reset & _T_1077) begin
          $fwrite(32'h80000002,
    ...
    `ifdef STOP_COND
      if (`STOP_COND) begin
    `endif
        if (io_in_b_valid & _T_1433 & ~reset) begin
          $fatal; // @[Monitor.scala 42:11]
        end
    `ifdef STOP_COND
      end
    ...
    `ifdef STOP_COND
      if (`STOP_COND) begin
    `endif
        if (_T_1063 & (io_in_b_valid & _T_1433 & ~reset)) begin
          $fatal; // @[Monitor.scala 42:11]
        end
    `ifdef STOP_COND
      end
    ...
    `ifdef PRINTF_COND
      if (`PRINTF_COND) begin
    `endif
        if (io_in_b_valid & _T_1433 & ~reset & _T_1063) begin
          $fwrite(32'h80000002,
    ...
    `ifdef STOP_COND
      if (`STOP_COND) begin
    `endif
        if (_T_1066 & (io_in_b_valid & _T_1433 & ~reset)) begin
          $fatal; // @[Monitor.scala 42:11]
        end
    `ifdef STOP_COND
      end
    ...
    `ifdef PRINTF_COND
      if (`PRINTF_COND) begin
    `endif
        if (io_in_b_valid & _T_1433 & ~reset & _T_1066) begin
          $fwrite(32'h80000002,
    ...
    `ifdef STOP_COND
      if (`STOP_COND) begin
    `endif
        if (_T_1069 & (io_in_b_valid & _T_1433 & ~reset)) begin
          $fatal; // @[Monitor.scala 42:11]
        end
    `ifdef STOP_COND
      end
    ...
    `ifdef PRINTF_COND
      if (`PRINTF_COND) begin
    `endif
        if (io_in_b_valid & _T_1433 & ~reset & _T_1069) begin
          $fwrite(32'h80000002,
    ...
    `ifdef STOP_COND
      if (`STOP_COND) begin
    `endif
        if (_T_1077 & (io_in_b_valid & _T_1433 & ~reset)) begin
          $fatal; // @[Monitor.scala 42:11]
        end
    `ifdef STOP_COND
      end
    ...
    `ifdef PRINTF_COND
      if (`PRINTF_COND) begin
    `endif
        if (io_in_b_valid & _T_1433 & ~reset & _T_1077) begin
          $fwrite(32'h80000002,
    ...
    `ifdef STOP_COND
      if (`STOP_COND) begin
    `endif
        if (_T_1081 & (io_in_b_valid & _T_1433 & ~reset)) begin
          $fatal; // @[Monitor.scala 42:11]
        end
    `ifdef STOP_COND
      end
    ...
    `ifdef PRINTF_COND
      if (`PRINTF_COND) begin
    `endif
        if (io_in_b_valid & _T_1433 & ~reset & _T_1081) begin
          $fwrite(32'h80000002,
    ...
    `ifdef STOP_COND
      if (`STOP_COND) begin
    `endif
        if (~_T_1962 & (_T_1961 & ~reset)) begin
          $fatal; // @[Monitor.scala 42:11]
        end
    `ifdef STOP_COND
      end
    ...
    `ifdef PRINTF_COND
      if (`PRINTF_COND) begin
    `endif
        if (_T_1961 & ~reset & ~_T_1962) begin
          $fwrite(32'h80000002,
    ...
    `ifdef STOP_COND
      if (`STOP_COND) begin
    `endif
        if (~_T_1970 & (_T_1961 & ~reset)) begin
          $fatal; // @[Monitor.scala 42:11]
        end
    `ifdef STOP_COND
      end
    ...
    `ifdef PRINTF_COND
      if (`PRINTF_COND) begin
    `endif
        if (_T_1961 & ~reset & ~_T_1970) begin
          $fwrite(32'h80000002,
    ...
    `ifdef STOP_COND
      if (`STOP_COND) begin
    `endif
        if (~_T_1974 & (_T_1961 & ~reset)) begin
          $fatal; // @[Monitor.scala 42:11]
        end
    `ifdef STOP_COND
      end
    ...
    `ifdef PRINTF_COND
      if (`PRINTF_COND) begin
    `endif
        if (_T_1961 & ~reset & ~_T_1974) begin
          $fwrite(32'h80000002,
    ...
    `ifdef STOP_COND
      if (`STOP_COND) begin
    `endif
        if (~_T_2177[0] & (_T_2173 & ~reset)) begin
          $fatal; // @[Monitor.scala 42:11]
        end
    `ifdef STOP_COND
      end
    ...
    `ifdef PRINTF_COND
      if (`PRINTF_COND) begin
    `endif
        if (_T_2173 & ~reset & ~_T_2177[0]) begin
          $fwrite(32'h80000002,
