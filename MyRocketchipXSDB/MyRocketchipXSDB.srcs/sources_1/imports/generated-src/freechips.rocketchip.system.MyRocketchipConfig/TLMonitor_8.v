...
`endif // RANDOMIZE_REG_INIT
  ...
  wire  _T_1132 = ~(|inflight) | plusarg_reader_out == 32'h0 | watchdog < plusarg_reader_out; // @[Monitor.scala 709:47]
  ...
  wire  _T_1158 = io_in_d_valid & d_first_2 & _T_870; // @[Monitor.scala 779:71]
  ...
  wire [18:0] _T_1166 = inflight_1 >> io_in_d_bits_source; // @[Monitor.scala 791:25]
  wire [7:0] c_size_lookup = _c_size_lookup_T_7[7:0];
  wire  _T_1176 = _GEN_79 == c_size_lookup; // @[Monitor.scala 795:36]
  ...
  always @(posedge clock) begin
    ...
    `ifdef STOP_COND
      if (`STOP_COND) begin
    `endif
        if (~_T_1166[0] & (_T_1158 & _T_2)) begin
          $fatal; // @[Monitor.scala 49:11]
        end
    `ifdef STOP_COND
      end
    ...
    `ifdef PRINTF_COND
      if (`PRINTF_COND) begin
    `endif
        if (_T_1158 & _T_2 & ~_T_1166[0]) begin
          $fwrite(32'h80000002,
            "Assertion failed: 'D' channel acknowledged for nothing inflight (connected at PeripheryBus.scala:54:7)\n    at Monitor.scala:49 assert(cond, message)\n"
            ); // @[Monitor.scala 49:11]
        end
