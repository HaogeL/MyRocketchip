...
`endif // RANDOMIZE_REG_INIT
  ...
  wire [32:0] _r_ok_T_42 = $signed(_r_ok_T_40) & -33'sh40000000; // @[Parameters.scala 137:52]
  ...
  wire [13:0] _GEN_16 = {{11'd0}, auto_in_ar_bits_addr[2:0]}; // @[ToTL.scala 98:59]
  wire [13:0] _r_addr_T_1 = 14'h3000 | _GEN_16; // @[ToTL.scala 98:59]
  wire [31:0] r_addr = r_ok ? auto_in_ar_bits_addr : {{18'd0}, _r_addr_T_1}; // @[ToTL.scala 98:23]
  reg [2:0] r_count_0; // @[ToTL.scala 99:28]
  reg [2:0] r_count_1; // @[ToTL.scala 99:28]
  wire [2:0] _GEN_1 = auto_in_ar_bits_id ? r_count_1 : r_count_0; // @[ToTL.scala 103:{50,50}]
  ...
  wire  _T_8 = ~reset; // @[ToTL.scala 106:14]
  ...
  wire  r_out_bits_user_amba_prot_privileged = auto_in_ar_bits_prot[0]; // @[ToTL.scala 113:45]
  wire  r_out_bits_user_amba_prot_secure = ~auto_in_ar_bits_prot[1]; // @[ToTL.scala 114:29]
  wire  r_out_bits_user_amba_prot_fetch = auto_in_ar_bits_prot[2]; // @[ToTL.scala 115:45]
  wire  r_out_bits_user_amba_prot_bufferable = auto_in_ar_bits_cache[0]; // @[ToTL.scala 116:46]
  wire  r_out_bits_user_amba_prot_modifiable = auto_in_ar_bits_cache[1]; // @[ToTL.scala 117:46]
  wire  r_out_bits_user_amba_prot_readalloc = auto_in_ar_bits_cache[2]; // @[ToTL.scala 118:46]
  wire  r_out_bits_user_amba_prot_writealloc = auto_in_ar_bits_cache[3]; // @[ToTL.scala 119:46]
  ...
  wire  w_out_valid = auto_in_aw_valid & auto_in_w_valid; // @[ToTL.scala 143:34]
  ...
  wire [2:0] _r_count_0_T_1 = r_count_0 + 3'h1; // @[ToTL.scala 124:43]
  wire [2:0] _r_count_1_T_1 = r_count_1 + 3'h1; // @[ToTL.scala 124:43]
  ...
  wire [32:0] _w_ok_T_32 = $signed(_w_ok_T_30) & -33'sh40000000; // @[Parameters.scala 137:52]
  ...
  wire [13:0] _GEN_19 = {{11'd0}, auto_in_aw_bits_addr[2:0]}; // @[ToTL.scala 131:59]
  wire [13:0] _w_addr_T_1 = 14'h3000 | _GEN_19; // @[ToTL.scala 131:59]
  wire [31:0] w_addr = w_ok ? auto_in_aw_bits_addr : {{18'd0}, _w_addr_T_1}; // @[ToTL.scala 131:23]
  reg [2:0] w_count_0; // @[ToTL.scala 132:28]
  reg [2:0] w_count_1; // @[ToTL.scala 132:28]
  wire [2:0] _GEN_5 = auto_in_aw_bits_id ? w_count_1 : w_count_0; // @[ToTL.scala 136:{50,50}]
  wire [3:0] w_id = {auto_in_aw_bits_id,_GEN_5[1:0],1'h1}; // @[Cat.scala 31:58]
  wire  _T_16 = ~auto_in_aw_valid; // @[ToTL.scala 139:15]
  ...
  wire  bundleIn_0_aw_ready = out_1_ready & auto_in_w_valid & auto_in_w_bits_last; // @[ToTL.scala 141:48]
  wire  w_out_bits_user_amba_prot_privileged = auto_in_aw_bits_prot[0]; // @[ToTL.scala 149:45]
  wire  w_out_bits_user_amba_prot_secure = ~auto_in_aw_bits_prot[1]; // @[ToTL.scala 150:29]
  wire  w_out_bits_user_amba_prot_fetch = auto_in_aw_bits_prot[2]; // @[ToTL.scala 151:45]
  wire  w_out_bits_user_amba_prot_bufferable = auto_in_aw_bits_cache[0]; // @[ToTL.scala 152:46]
  wire  w_out_bits_user_amba_prot_modifiable = auto_in_aw_bits_cache[1]; // @[ToTL.scala 153:46]
  wire  w_out_bits_user_amba_prot_readalloc = auto_in_aw_bits_cache[2]; // @[ToTL.scala 154:46]
  wire  w_out_bits_user_amba_prot_writealloc = auto_in_aw_bits_cache[3]; // @[ToTL.scala 155:46]
  ...
  wire [2:0] _w_count_0_T_1 = w_count_0 + 3'h1; // @[ToTL.scala 160:43]
  wire [2:0] _w_count_1_T_1 = w_count_1 + 3'h1; // @[ToTL.scala 160:43]
  ...
  wire  ok_r_ready = deq_io_enq_ready; // @[ToTL.scala 166:23 Decoupled.scala 365:17]
  wire  ok_b_ready = q_b_deq_io_enq_ready; // @[ToTL.scala 165:23 Decoupled.scala 365:17]
  wire  bundleOut_0_d_ready = d_hasData ? ok_r_ready : ok_b_ready; // @[ToTL.scala 172:25]
  ...
  reg [2:0] b_count_0; // @[ToTL.scala 194:28]
  reg [2:0] b_count_1; // @[ToTL.scala 194:28]
  wire  q_b_bits_id = q_b_deq_io_deq_bits_id; // @[Decoupled.scala 401:19 402:14]
  wire [2:0] _GEN_11 = q_b_bits_id ? b_count_1 : b_count_0; // @[ToTL.scala 195:{43,43}]
  wire [2:0] _GEN_13 = q_b_bits_id ? w_count_1 : w_count_0; // @[ToTL.scala 195:{43,43}]
  wire  b_allow = _GEN_11 != _GEN_13; // @[ToTL.scala 195:43]
  wire [1:0] b_sel = 2'h1 << q_b_bits_id; // @[OneHot.scala 64:12]
  wire  q_b_valid = q_b_deq_io_deq_valid; // @[Decoupled.scala 401:19 403:15]
  wire  bundleIn_0_b_valid = q_b_valid & b_allow; // @[ToTL.scala 203:31]
  wire  _T_111 = auto_in_b_ready & bundleIn_0_b_valid; // @[Decoupled.scala 50:35]
  wire [2:0] _b_count_0_T_1 = b_count_0 + 3'h1; // @[ToTL.scala 199:42]
  wire [2:0] _b_count_1_T_1 = b_count_1 + 3'h1; // @[ToTL.scala 199:42]
  Queue_16 deq ( // @[Decoupled.scala 361:21]
    .clock(deq_clock),
    .reset(deq_reset),
  ...
  Queue_17 q_b_deq ( // @[Decoupled.scala 361:21]
    .clock(q_b_deq_clock),
    .reset(q_b_deq_reset),
  ...
  assign auto_in_aw_ready = out_1_ready & auto_in_w_valid & auto_in_w_bits_last; // @[ToTL.scala 141:48]
  assign auto_in_w_ready = out_1_ready & auto_in_aw_valid; // @[ToTL.scala 142:34]
  assign auto_in_b_valid = q_b_valid & b_allow; // @[ToTL.scala 203:31]
  ...
  assign auto_out_d_ready = d_hasData ? ok_r_ready : ok_b_ready; // @[ToTL.scala 172:25]
  assign deq_clock = clock;
  assign deq_reset = reset;
  assign deq_io_enq_valid = auto_out_d_valid & d_hasData; // @[ToTL.scala 173:33]
  assign deq_io_enq_bits_id = auto_out_d_bits_source[3]; // @[ToTL.scala 176:43]
  ...
  assign q_b_deq_io_enq_valid = auto_out_d_valid & ~d_hasData; // @[ToTL.scala 174:33]
  assign q_b_deq_io_enq_bits_id = auto_out_d_bits_source[3]; // @[ToTL.scala 185:43]
  assign q_b_deq_io_enq_bits_resp = auto_out_d_bits_denied | auto_out_d_bits_corrupt ? 2'h2 : 2'h0; // @[ToTL.scala 168:23]
  assign q_b_deq_io_deq_ready = auto_in_b_ready & b_allow; // @[ToTL.scala 204:31]
  always @(posedge clock) begin
    if (reset) begin // @[ToTL.scala 99:28]
      r_count_0 <= 3'h0; // @[ToTL.scala 99:28]
    end else if (_T_12 & r_sel[0]) begin // @[ToTL.scala 124:34]
      r_count_0 <= _r_count_0_T_1; // @[ToTL.scala 124:38]
    end
    if (reset) begin // @[ToTL.scala 99:28]
      r_count_1 <= 3'h0; // @[ToTL.scala 99:28]
    end else if (_T_12 & r_sel[1]) begin // @[ToTL.scala 124:34]
      r_count_1 <= _r_count_1_T_1; // @[ToTL.scala 124:38]
    end
    ...
    if (reset) begin // @[ToTL.scala 132:28]
      w_count_0 <= 3'h0; // @[ToTL.scala 132:28]
    end else if (_T_36 & w_sel[0]) begin // @[ToTL.scala 160:34]
      w_count_0 <= _w_count_0_T_1; // @[ToTL.scala 160:38]
    end
    if (reset) begin // @[ToTL.scala 132:28]
      w_count_1 <= 3'h0; // @[ToTL.scala 132:28]
    end else if (_T_36 & w_sel[1]) begin // @[ToTL.scala 160:34]
      w_count_1 <= _w_count_1_T_1; // @[ToTL.scala 160:38]
    end
    if (reset) begin // @[Arbiter.scala 116:26]
    ...
    if (reset) begin // @[ToTL.scala 194:28]
      b_count_0 <= 3'h0; // @[ToTL.scala 194:28]
    end else if (_T_111 & b_sel[0]) begin // @[ToTL.scala 199:33]
      b_count_0 <= _b_count_0_T_1; // @[ToTL.scala 199:37]
    end
    if (reset) begin // @[ToTL.scala 194:28]
      b_count_1 <= 3'h0; // @[ToTL.scala 194:28]
    end else if (_T_111 & b_sel[1]) begin // @[ToTL.scala 199:33]
      b_count_1 <= _b_count_1_T_1; // @[ToTL.scala 199:37]
    end
    `ifndef SYNTHESIS
    `ifdef STOP_COND
      if (`STOP_COND) begin
