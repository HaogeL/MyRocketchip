...
`endif // RANDOMIZE_REG_INIT
  ...
  wire [32:0] _support1_T_33 = $signed(_support1_T_31) & 33'shc0000000; // @[Parameters.scala 137:52]
  ...
  wire  narrow = irr_bits_size != 3'h3; // @[Fragmenter.scala 96:34]
  ...
  wire [32:0] _support1_T_66 = $signed(_support1_T_64) & 33'shc0000000; // @[Parameters.scala 137:52]
  ...
  wire  narrow_1 = irr_1_bits_size != 3'h3; // @[Fragmenter.scala 96:34]
  ...
  wire  _bundleOut_0_w_valid_T_1 = ~w_idle | wbeats_valid; // @[Fragmenter.scala 176:51]
  wire  bundleOut_0_w_valid = in_w_valid & (~w_idle | wbeats_valid); // @[Fragmenter.scala 176:33]
  ...
  wire [1:0] _GEN_13 = auto_out_b_bits_id ? error_1 : error_0; // @[Fragmenter.scala 196:{41,41}]
  ...
  Queue_18 deq ( // @[Decoupled.scala 361:21]
    .clock(deq_clock),
    .reset(deq_reset),
  ...
  Queue_18 deq_1 ( // @[Decoupled.scala 361:21]
    .clock(deq_1_clock),
    .reset(deq_1_reset),
  ...
  Queue_10 in_w_deq ( // @[Decoupled.scala 361:21]
  ...
  assign auto_in_b_bits_resp = auto_out_b_bits_resp | _GEN_13; // @[Fragmenter.scala 196:41]
  ...
  assign auto_in_r_bits_last = auto_out_r_bits_last & auto_out_r_bits_echo_real_last; // @[Fragmenter.scala 186:41]
  ...
  assign auto_out_w_valid = in_w_valid & (~w_idle | wbeats_valid); // @[Fragmenter.scala 176:33]
