...
`endif // RANDOMIZE_REG_INIT
  ...
  wire [16:0] _T_87 = io_in_a_bits_address ^ 17'h10000; // @[Parameters.scala 137:31]
  wire [17:0] _T_88 = {1'b0,$signed(_T_87)}; // @[Parameters.scala 137:49]
  wire [17:0] _T_90 = $signed(_T_88) & -18'sh10000; // @[Parameters.scala 137:52]
  wire  _T_91 = $signed(_T_90) == 18'sh0; // @[Parameters.scala 137:67]
  ...
  wire  _T_376 = io_in_a_bits_opcode == 3'h1; // @[Monitor.scala 122:25]
  wire [7:0] _T_423 = ~mask; // @[Monitor.scala 127:33]
  wire [7:0] _T_424 = io_in_a_bits_mask & _T_423; // @[Monitor.scala 127:31]
  wire  _T_425 = _T_424 == 8'h0; // @[Monitor.scala 127:40]
  wire  _T_429 = io_in_a_bits_opcode == 3'h2; // @[Monitor.scala 130:25]
  wire  _T_472 = io_in_a_bits_param <= 3'h4; // @[Bundles.scala 138:33]
  wire  _T_480 = io_in_a_bits_opcode == 3'h3; // @[Monitor.scala 138:25]
  wire  _T_523 = io_in_a_bits_param <= 3'h3; // @[Bundles.scala 145:30]
  wire  _T_531 = io_in_a_bits_opcode == 3'h5; // @[Monitor.scala 146:25]
  wire  _T_574 = io_in_a_bits_param <= 3'h1; // @[Bundles.scala 158:28]
  ...
  wire  _T_732 = io_in_a_valid & ~a_first; // @[Monitor.scala 389:19]
  wire  _T_733 = io_in_a_bits_opcode == opcode; // @[Monitor.scala 390:32]
  wire  _T_737 = io_in_a_bits_param == param; // @[Monitor.scala 391:32]
  wire  _T_741 = io_in_a_bits_size == size; // @[Monitor.scala 392:32]
  wire  _T_745 = io_in_a_bits_source == source; // @[Monitor.scala 393:32]
  wire  _T_749 = io_in_a_bits_address == address; // @[Monitor.scala 394:32]
  ...
  wire  _T_756 = io_in_d_valid & ~d_first; // @[Monitor.scala 541:19]
  wire  _T_765 = io_in_d_bits_size == size_1; // @[Monitor.scala 544:29]
  wire  _T_769 = io_in_d_bits_source == source_1; // @[Monitor.scala 545:29]
  ...
  wire  _T_783 = io_in_a_valid & a_first_1; // @[Monitor.scala 648:26]
  wire [31:0] _a_set_wo_ready_T = 32'h1 << io_in_a_bits_source; // @[OneHot.scala 57:35]
  wire  _T_786 = a_first_done & a_first_1; // @[Monitor.scala 652:27]
  ...
  wire [18:0] _T_788 = inflight >> io_in_a_bits_source; // @[Monitor.scala 658:26]
  wire  _T_790 = ~_T_788[0]; // @[Monitor.scala 658:17]
  wire [31:0] _GEN_16 = a_first_done & a_first_1 ? _a_set_wo_ready_T : 32'h0; // @[Monitor.scala 652:72 653:28]
  wire [258:0] _GEN_19 = a_first_done & a_first_1 ? _a_opcodes_set_T_1 : 259'h0; // @[Monitor.scala 652:72 656:28]
  wire [258:0] _GEN_20 = a_first_done & a_first_1 ? _a_sizes_set_T_1 : 259'h0; // @[Monitor.scala 652:72 657:28]
  wire  _T_794 = io_in_d_valid & d_first_1; // @[Monitor.scala 671:26]
  ...
  wire [31:0] _GEN_22 = _d_first_T & d_first_1 ? _d_clr_wo_ready_T : 32'h0; // @[Monitor.scala 675:91 676:21]
  wire [270:0] _GEN_23 = _d_first_T & d_first_1 ? _d_opcodes_clr_T_5 : 271'h0; // @[Monitor.scala 675:91 677:21]
  wire  _same_cycle_resp_T_2 = io_in_a_bits_source == io_in_d_bits_source; // @[Monitor.scala 681:113]
  wire  same_cycle_resp = _T_783 & io_in_a_bits_source == io_in_d_bits_source; // @[Monitor.scala 681:88]
  wire [18:0] _T_807 = inflight >> io_in_d_bits_source; // @[Monitor.scala 682:25]
  wire  _T_809 = _T_807[0] | same_cycle_resp; // @[Monitor.scala 682:49]
  ...
  wire  _T_814 = 3'h1 == _GEN_40; // @[Monitor.scala 686:39]
  wire  _T_815 = 3'h1 == _GEN_32 | _T_814; // @[Monitor.scala 685:77]
  wire  _T_819 = io_in_a_bits_size == io_in_d_bits_size; // @[Monitor.scala 687:36]
  ...
  wire  _T_826 = 3'h1 == _GEN_56; // @[Monitor.scala 690:38]
  wire  _T_827 = 3'h1 == _GEN_48 | _T_826; // @[Monitor.scala 689:72]
  wire [3:0] a_size_lookup = _a_size_lookup_T_7[3:0];
  wire [3:0] _GEN_82 = {{1'd0}, io_in_d_bits_size}; // @[Monitor.scala 691:36]
  wire  _T_831 = _GEN_82 == a_size_lookup; // @[Monitor.scala 691:36]
  wire  _T_839 = _T_794 & a_first_1 & io_in_a_valid & _same_cycle_resp_T_2; // @[Monitor.scala 694:65]
  wire  _T_843 = ~io_in_d_ready | io_in_a_ready; // @[Monitor.scala 695:32]
  ...
  wire  _T_852 = ~(|inflight) | plusarg_reader_out == 32'h0 | watchdog < plusarg_reader_out; // @[Monitor.scala 709:47]
  ...
  always @(posedge clock) begin
    ...
    `ifdef STOP_COND
      if (`STOP_COND) begin
    `endif
        if (io_in_a_valid & _T_376 & ~reset) begin
          $fatal; // @[Monitor.scala 42:11]
        end
    `ifdef STOP_COND
      end
    ...
    `ifdef STOP_COND
      if (`STOP_COND) begin
    `endif
        if (~source_ok & (io_in_a_valid & _T_376 & ~reset)) begin
          $fatal; // @[Monitor.scala 42:11]
        end
    `ifdef STOP_COND
      end
    ...
    `ifdef PRINTF_COND
      if (`PRINTF_COND) begin
    `endif
        if (io_in_a_valid & _T_376 & ~reset & ~source_ok) begin
          $fwrite(32'h80000002,
    ...
    `ifdef STOP_COND
      if (`STOP_COND) begin
    `endif
        if (~is_aligned & (io_in_a_valid & _T_376 & ~reset)) begin
          $fatal; // @[Monitor.scala 42:11]
        end
    `ifdef STOP_COND
      end
    ...
    `ifdef PRINTF_COND
      if (`PRINTF_COND) begin
    `endif
        if (io_in_a_valid & _T_376 & ~reset & ~is_aligned) begin
          $fwrite(32'h80000002,
    ...
    `ifdef STOP_COND
      if (`STOP_COND) begin
    `endif
        if (~_T_313 & (io_in_a_valid & _T_376 & ~reset)) begin
          $fatal; // @[Monitor.scala 42:11]
        end
    `ifdef STOP_COND
      end
    ...
    `ifdef PRINTF_COND
      if (`PRINTF_COND) begin
    `endif
        if (io_in_a_valid & _T_376 & ~reset & ~_T_313) begin
          $fwrite(32'h80000002,
    ...
    `ifdef STOP_COND
      if (`STOP_COND) begin
    `endif
        if (~_T_425 & (io_in_a_valid & _T_376 & ~reset)) begin
          $fatal; // @[Monitor.scala 42:11]
        end
    `ifdef STOP_COND
      end
    ...
    `ifdef PRINTF_COND
      if (`PRINTF_COND) begin
    `endif
        if (io_in_a_valid & _T_376 & ~reset & ~_T_425) begin
          $fwrite(32'h80000002,
    ...
    `ifdef STOP_COND
      if (`STOP_COND) begin
    `endif
        if (io_in_a_valid & _T_429 & ~reset) begin
          $fatal; // @[Monitor.scala 42:11]
        end
    `ifdef STOP_COND
      end
    ...
    `ifdef STOP_COND
      if (`STOP_COND) begin
    `endif
        if (~source_ok & (io_in_a_valid & _T_429 & ~reset)) begin
          $fatal; // @[Monitor.scala 42:11]
        end
    `ifdef STOP_COND
      end
    ...
    `ifdef PRINTF_COND
      if (`PRINTF_COND) begin
    `endif
        if (io_in_a_valid & _T_429 & ~reset & ~source_ok) begin
          $fwrite(32'h80000002,
    ...
    `ifdef STOP_COND
      if (`STOP_COND) begin
    `endif
        if (~is_aligned & (io_in_a_valid & _T_429 & ~reset)) begin
          $fatal; // @[Monitor.scala 42:11]
        end
    `ifdef STOP_COND
      end
    ...
    `ifdef PRINTF_COND
      if (`PRINTF_COND) begin
    `endif
        if (io_in_a_valid & _T_429 & ~reset & ~is_aligned) begin
          $fwrite(32'h80000002,
    ...
    `ifdef STOP_COND
      if (`STOP_COND) begin
    `endif
        if (~_T_472 & (io_in_a_valid & _T_429 & ~reset)) begin
          $fatal; // @[Monitor.scala 42:11]
        end
    `ifdef STOP_COND
      end
    ...
    `ifdef PRINTF_COND
      if (`PRINTF_COND) begin
    `endif
        if (io_in_a_valid & _T_429 & ~reset & ~_T_472) begin
          $fwrite(32'h80000002,
    ...
    `ifdef STOP_COND
      if (`STOP_COND) begin
    `endif
        if (~_T_317 & (io_in_a_valid & _T_429 & ~reset)) begin
          $fatal; // @[Monitor.scala 42:11]
        end
    `ifdef STOP_COND
      end
    ...
    `ifdef PRINTF_COND
      if (`PRINTF_COND) begin
    `endif
        if (io_in_a_valid & _T_429 & ~reset & ~_T_317) begin
          $fwrite(32'h80000002,
    ...
    `ifdef STOP_COND
      if (`STOP_COND) begin
    `endif
        if (io_in_a_valid & _T_480 & ~reset) begin
          $fatal; // @[Monitor.scala 42:11]
        end
    `ifdef STOP_COND
      end
    ...
    `ifdef STOP_COND
      if (`STOP_COND) begin
    `endif
        if (~source_ok & (io_in_a_valid & _T_480 & ~reset)) begin
          $fatal; // @[Monitor.scala 42:11]
        end
    `ifdef STOP_COND
      end
    ...
    `ifdef PRINTF_COND
      if (`PRINTF_COND) begin
    `endif
        if (io_in_a_valid & _T_480 & ~reset & ~source_ok) begin
          $fwrite(32'h80000002,
    ...
    `ifdef STOP_COND
      if (`STOP_COND) begin
    `endif
        if (~is_aligned & (io_in_a_valid & _T_480 & ~reset)) begin
          $fatal; // @[Monitor.scala 42:11]
        end
    `ifdef STOP_COND
      end
    ...
    `ifdef PRINTF_COND
      if (`PRINTF_COND) begin
    `endif
        if (io_in_a_valid & _T_480 & ~reset & ~is_aligned) begin
          $fwrite(32'h80000002,
    ...
    `ifdef STOP_COND
      if (`STOP_COND) begin
    `endif
        if (~_T_523 & (io_in_a_valid & _T_480 & ~reset)) begin
          $fatal; // @[Monitor.scala 42:11]
        end
    `ifdef STOP_COND
      end
    ...
    `ifdef PRINTF_COND
      if (`PRINTF_COND) begin
    `endif
        if (io_in_a_valid & _T_480 & ~reset & ~_T_523) begin
          $fwrite(32'h80000002,
    ...
    `ifdef STOP_COND
      if (`STOP_COND) begin
    `endif
        if (~_T_317 & (io_in_a_valid & _T_480 & ~reset)) begin
          $fatal; // @[Monitor.scala 42:11]
        end
    `ifdef STOP_COND
      end
    ...
    `ifdef PRINTF_COND
      if (`PRINTF_COND) begin
    `endif
        if (io_in_a_valid & _T_480 & ~reset & ~_T_317) begin
          $fwrite(32'h80000002,
    ...
    `ifdef STOP_COND
      if (`STOP_COND) begin
    `endif
        if (io_in_a_valid & _T_531 & ~reset) begin
          $fatal; // @[Monitor.scala 42:11]
        end
    `ifdef STOP_COND
      end
    ...
    `ifdef STOP_COND
      if (`STOP_COND) begin
    `endif
        if (~source_ok & (io_in_a_valid & _T_531 & ~reset)) begin
          $fatal; // @[Monitor.scala 42:11]
        end
    `ifdef STOP_COND
      end
    ...
    `ifdef PRINTF_COND
      if (`PRINTF_COND) begin
    `endif
        if (io_in_a_valid & _T_531 & ~reset & ~source_ok) begin
          $fwrite(32'h80000002,
    ...
    `ifdef STOP_COND
      if (`STOP_COND) begin
    `endif
        if (~is_aligned & (io_in_a_valid & _T_531 & ~reset)) begin
          $fatal; // @[Monitor.scala 42:11]
        end
    `ifdef STOP_COND
      end
    ...
    `ifdef PRINTF_COND
      if (`PRINTF_COND) begin
    `endif
        if (io_in_a_valid & _T_531 & ~reset & ~is_aligned) begin
          $fwrite(32'h80000002,
    ...
    `ifdef STOP_COND
      if (`STOP_COND) begin
    `endif
        if (~_T_574 & (io_in_a_valid & _T_531 & ~reset)) begin
          $fatal; // @[Monitor.scala 42:11]
        end
    `ifdef STOP_COND
      end
    ...
    `ifdef PRINTF_COND
      if (`PRINTF_COND) begin
    `endif
        if (io_in_a_valid & _T_531 & ~reset & ~_T_574) begin
          $fwrite(32'h80000002,
    ...
    `ifdef STOP_COND
      if (`STOP_COND) begin
    `endif
        if (~_T_317 & (io_in_a_valid & _T_531 & ~reset)) begin
          $fatal; // @[Monitor.scala 42:11]
        end
    `ifdef STOP_COND
      end
    ...
    `ifdef PRINTF_COND
      if (`PRINTF_COND) begin
    `endif
        if (io_in_a_valid & _T_531 & ~reset & ~_T_317) begin
          $fwrite(32'h80000002,
    ...
    `ifdef STOP_COND
      if (`STOP_COND) begin
    `endif
        if (~_T_157 & (io_in_a_valid & _T_531 & ~reset)) begin
          $fatal; // @[Monitor.scala 42:11]
        end
    `ifdef STOP_COND
      end
    ...
    `ifdef PRINTF_COND
      if (`PRINTF_COND) begin
    `endif
        if (io_in_a_valid & _T_531 & ~reset & ~_T_157) begin
          $fwrite(32'h80000002,
    ...
    `ifdef STOP_COND
      if (`STOP_COND) begin
    `endif
        if (~_T_815 & (_T_794 & same_cycle_resp & _T_2)) begin
          $fatal; // @[Monitor.scala 49:11]
        end
    `ifdef STOP_COND
      end
    ...
    `ifdef PRINTF_COND
      if (`PRINTF_COND) begin
    `endif
        if (_T_794 & same_cycle_resp & _T_2 & ~_T_815) begin
          $fwrite(32'h80000002,
    ...
    `ifdef STOP_COND
      if (`STOP_COND) begin
    `endif
        if (~_T_819 & (_T_794 & same_cycle_resp & _T_2)) begin
          $fatal; // @[Monitor.scala 49:11]
        end
    `ifdef STOP_COND
      end
    ...
    `ifdef PRINTF_COND
      if (`PRINTF_COND) begin
    `endif
        if (_T_794 & same_cycle_resp & _T_2 & ~_T_819) begin
          $fwrite(32'h80000002,
    ...
    `ifdef STOP_COND
      if (`STOP_COND) begin
    `endif
        if (~_T_827 & (_T_794 & ~same_cycle_resp & _T_2)) begin
          $fatal; // @[Monitor.scala 49:11]
        end
    `ifdef STOP_COND
      end
    ...
    `ifdef PRINTF_COND
      if (`PRINTF_COND) begin
    `endif
        if (_T_794 & ~same_cycle_resp & _T_2 & ~_T_827) begin
          $fwrite(32'h80000002,
            "Assertion failed: 'D' channel contains improper opcode response (connected at BootROM.scala:84:68)\n    at Monitor.scala:49 assert(cond, message)\n"
            ); // @[Monitor.scala 49:11]
        end
    ...
    `ifdef STOP_COND
      if (`STOP_COND) begin
    `endif
        if (~_T_831 & (_T_794 & ~same_cycle_resp & _T_2)) begin
          $fatal; // @[Monitor.scala 49:11]
        end
    `ifdef STOP_COND
      end
    ...
    `ifdef PRINTF_COND
      if (`PRINTF_COND) begin
    `endif
        if (_T_794 & ~same_cycle_resp & _T_2 & ~_T_831) begin
          $fwrite(32'h80000002,
            "Assertion failed: 'D' channel contains improper response size (connected at BootROM.scala:84:68)\n    at Monitor.scala:49 assert(cond, message)\n"
            ); // @[Monitor.scala 49:11]
        end
