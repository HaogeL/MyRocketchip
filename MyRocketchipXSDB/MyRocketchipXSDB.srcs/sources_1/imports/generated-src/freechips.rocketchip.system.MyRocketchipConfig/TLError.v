...
`endif // RANDOMIZE_REG_INIT
  ...
  wire [4:0] a_io_enq_bits_source; // @[Decoupled.scala 361:21]
  ...
  wire [4:0] a_io_deq_bits_source; // @[Decoupled.scala 361:21]
  ...
  wire [3:0] da_bits_size = a_io_deq_bits_size; // @[Error.scala 23:18 35:21]
  ...
  Queue_23 a ( // @[Decoupled.scala 361:21]
    .clock(a_clock),
    .reset(a_reset),
  ...
  assign monitor_io_in_d_valid = a_io_deq_valid & a_last; // @[Error.scala 31:25]
  assign monitor_io_in_d_bits_opcode = 3'h7 == a_io_deq_bits_opcode ? 3'h4 : _GEN_8; // @[Error.scala 33:{21,21}]
  assign monitor_io_in_d_bits_size = a_io_deq_bits_size; // @[Error.scala 23:18 35:21]
  assign monitor_io_in_d_bits_source = a_io_deq_bits_source; // @[Error.scala 23:18 36:21]
