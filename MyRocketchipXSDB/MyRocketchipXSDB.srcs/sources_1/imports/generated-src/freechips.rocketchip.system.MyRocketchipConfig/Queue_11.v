...
`endif // RANDOMIZE_REG_INIT
  ...
  reg [4:0] ram_echo_tl_state_source [0:0]; // @[Decoupled.scala 259:95]
  ...
  wire [4:0] ram_echo_tl_state_source_io_deq_bits_MPORT_data; // @[Decoupled.scala 259:95]
  wire [4:0] ram_echo_tl_state_source_MPORT_data; // @[Decoupled.scala 259:95]
