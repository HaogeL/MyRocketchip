...
`endif // RANDOMIZE_REG_INIT
  ...
  wire [32:0] fma_io_a; // @[FPU.scala 711:19]
  wire [32:0] fma_io_b; // @[FPU.scala 711:19]
  wire [32:0] fma_io_c; // @[FPU.scala 711:19]
  wire [2:0] fma_io_roundingMode; // @[FPU.scala 711:19]
  wire [32:0] fma_io_out; // @[FPU.scala 711:19]
  ...
  wire [64:0] zero = _zero_T & 65'h100000000; // @[FPU.scala 703:50]
  MulAddRecFNPipe fma ( // @[FPU.scala 711:19]
    .clock(fma_clock),
    .reset(fma_reset),
  ...
  assign io_out_bits_data = {{32'd0}, fma_io_out}; // @[FPU.scala 720:17 721:12]
  assign io_out_bits_exc = fma_io_exceptionFlags; // @[FPU.scala 720:17 722:11]
  ...
  assign fma_io_a = in_in1[32:0]; // @[FPU.scala 716:12]
  assign fma_io_b = in_in2[32:0]; // @[FPU.scala 717:12]
  assign fma_io_c = in_in3[32:0]; // @[FPU.scala 718:12]
  ...
  always @(posedge clock) begin
    ...
    if (io_in_valid) begin // @[FPU.scala 701:22]
      if (io_in_bits_swap23) begin // @[FPU.scala 707:23]
        in_in2 <= 65'h80000000; // @[FPU.scala 707:32]
      end else begin
